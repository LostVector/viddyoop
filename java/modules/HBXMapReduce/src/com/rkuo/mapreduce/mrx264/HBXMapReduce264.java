...
public class HBXMapReduce264 extends HBXMapReduceBase {
...
//    protected final static String HADOOP_USER = "vidoop";
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(HBXMapper264.class);
//        job.setCombinerClass(HBXReducer.class); // not used
        job.setReducerClass(HBXReducer264.class);
        ...
        job.setJarByClass(HBXMapper264.class);
...
//        c.unset("fs.default.name"); // tried to remove warning from hadoop about fs.default.name being deprecated, but job submission barfs.  Go hadoop.
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new HBXMapReduce264(), args);
        if( res != 0 ) {
